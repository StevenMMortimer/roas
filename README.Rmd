...
-   report_request(): Run over 800 different template reports
      -  Campaign Delivery
      -  Account Revenue
      -  More...
-   basic_inventory_request(): Run inventory reports over 18 different types 
      -  Site
      -  Section
      -  Campaign
      -  More...
-   search_inventory_request(): Run inventory reports based on keyword search terms
-   geo_inventory_request(): Run Site or Secton inventory across geography types 
      - Country
      - State
      - Postal Code
      - DMA
...
based on your API instance. Set them using the `option()` function.
