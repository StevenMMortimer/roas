...
|:----------------------------|:------------------------------------------------------------------------|
| oas_add\                    | Add an instance of an OAS object (requires elevated permissions)        |
| oas_update\                 | Update an instance of an OAS object (requires elevated permissions)     |
| oas_copy\                   | Copy an instance of an OAS object (requires elevated permissions)       |
| oas_upload\                 | Upload an OAS object (requires elevated permissions)                    |
| oas_analytics\_report\      | Run an template report (e.g. Acquisition, Nagivation, Retention, etc.)  |
